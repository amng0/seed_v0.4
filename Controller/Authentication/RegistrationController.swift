...
class RegistrationController: UIViewController {
    ...
    private lazy var emailContainerView: UIView = {
        let image = #imageLiteral(resourceName: "seedlogo")
    ...
    @objc func handleRegistration() {
        ...
        let credentials = AuthCredentials(email: email, password: password, fullname: firstname, username: username, profileImage: profileImage)
